...
let
  ...
  synapseDomain = "matrix.${config.networking.domain}";
...
in
{
    ...
    virtualHosts = {
      ${baseDomain} = {
        ...
        locations."/".extraConfig = ''
          return 301 $scheme://element.zebre.us$request_uri;
        '';
      };
      ${synapseDomain} = {
        enableACME = true;
  ...
  services.coturn = {
    ...
    static-auth-secret = config.modules.secretss.coturn-static-auth-secret;
    realm = turnDomain;
